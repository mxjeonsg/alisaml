 ...
 * [PUBLIC API]
 */
// Why in the glorious think of fucking Mercury i'm forced to do this
// kind of stupidish bitchy stuff????
#include <stdarg.h>
struct xml_node* xml_easy_child(struct xml_node* node, uint8_t const* child_name, ...) {
	...
	/*va_list*/ __gnuc_va_list arguments;
